...
CREATE TABLE `stats` (
  `st_id` int(32) NOT NULL AUTO_INCREMENT,
  `st_pdv` int(32) DEFAULT NULL,
  `st_libelle` varchar(128) DEFAULT NULL,
  `st_domain` varchar(32) DEFAULT NULL,
  `st_requete` text,
  `st_sql` text,
  `st_faitpar` int(32) DEFAULT NULL,
  `st_cree` datetime DEFAULT NULL,
  `st_modifie` datetime DEFAULT NULL,
  PRIMARY KEY (`st_id`),
  KEY `i53` (`st_pdv`)
